...
// <DropdownMenuContent
//   className="w-[200px] max-h-[250px] overflow-y-auto bg-neutral-900 border border-neutral-700 shadow-md rounded-md scrollbar-hide"
// >
//   {LANGUAGE_LABELS.map((lang) => {
//     const languageColors: Record<string, string> = {
//       JavaScript: 'bg-yellow-200 text-yellow-900',
...
// <DropdownMenuContent
//   className="w-full max-h-[250px] overflow-y-auto bg-neutral-900 border border-neutral-700 shadow-lg rounded-md scrollbar-hide"
// >
//   {DIFFICULTY_LABELS.map((label) => {
//     const difficultyColors: Record<string, string> = {
//       'good-first-issue': 'bg-green-100 text-green-900 ',
...
//           "cursor-pointer transition-colors mt-1 px-2 py-1 rounded-md w-full text-center",
//           colorClasses,
//            "hover:-translate-y-0.5 hover:shadow-md hover:ring-1 hover:ring-white/20"// subtle hover effect
//         )}
//       >
//         <span className="block w-full font-medium text-sm capitalize">
//           {label.replace('-', ' ')}
